...
<div class="container">
    ...
    <div id="songsContainer" class="row row-cols-lg-4 row-cols-md-3 row-cols-1">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    applyFiltersBtn.addEventListener('click', function() {
        ...
        activeFilters = {};
        const filterElements = ['categoryFilter', 'typeFilter', 'toneFilter', 'intensityFilter', 'sortFilter', 'tempoFilter'];
    ...
    async function resetAndReload() {
        ...
        try {
            ...
            if (data.songs && data.songs.length > 0) {
                ...
                songsContainer.innerHTML = '<div class="col-12 text-center py-5"><p class="text-muted">Nenhuma música encontrada com os filtros aplicados.</p></div>';
                hasMore = false;
                scrollTrigger.classList.add('d-none');
            }
        } catch (error) {
